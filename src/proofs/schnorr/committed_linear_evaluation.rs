...
//     EncryptionKey,
//     CommitmentScheme,
// > { _scalar_choice: PhantomData<Scalar>, _group_element_choice: PhantomData<GroupElement>,
...
// > _encryption_key_choice: PhantomData<EncryptionKey>, _commitment_choice:
// > PhantomData<CommitmentScheme>,
// }
//
...
//     Uint<SCALAR_LIMBS>:
//         ConcatMixed<Uint<RANDOMNESS_SPACE_SCALAR_LIMBS>, MixedOutput =
// Uint<WITNESS_SCALAR_LIMBS>>,     Uint<CIPHERTEXT_SPACE_SCALAR_LIMBS>:
...
// > direct_product::GroupElement< WITNESS_SCALAR_LIMBS, SCALAR_LIMBS,
// > RANDOMNESS_SPACE_SCALAR_LIMBS, Scalar, RandomnessSpaceGroupElement, >,
// > direct_product::GroupElement< PUBLIC_VALUE_SCALAR_LIMBS, CIPHERTEXT_SPACE_SCALAR_LIMBS,
// > SCALAR_LIMBS, CiphertextSpaceGroupElement, GroupElement, >, Language< MASK_LIMBS, SCALAR_LIMBS,
// > RANDOMNESS_SPACE_SCALAR_LIMBS, CIPHERTEXT_SPACE_SCALAR_LIMBS, DIMENSION, WITNESS_SCALAR_LIMBS,
// > PUBLIC_VALUE_SCALAR_LIMBS, Scalar, RandomnessSpaceGroupElement, CiphertextSpaceGroupElement,
// > GroupElement, EncryptionKey, CommitmentScheme, >, ProtocolContext,
// >;
