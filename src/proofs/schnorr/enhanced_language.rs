...
pub type EnhancedLanguageWitness<const NUM_RANGE_CLAIMS: usize, const RANGE_CLAIM_LIMBS: usize, L> =
    direct_product::ThreeWayGroupElement<
        self_product::GroupElement<
            NUM_RANGE_CLAIMS,
            power_of_two_moduli::GroupElement<RANGE_CLAIM_LIMBS>, /* TODO: change to witness
                                                                   * mask limb */
        >,
...
> = direct_product::GroupElement<
    RangeProofCommitmentSchemeCommitmentSpaceGroupElement<NUM_RANGE_CLAIMS, RANGE_CLAIM_LIMBS, L>,
    RemainingStatementSpaceGroupElement<NUM_RANGE_CLAIMS, RANGE_CLAIM_LIMBS, L>,
>;
...
pub type RangeProof<const NUM_RANGE_CLAIMS: usize, const RANGE_CLAIM_LIMBS: usize, L> =
...
> = range::CommitmentScheme<
    NUM_RANGE_CLAIMS,
    RANGE_CLAIM_LIMBS,
    RangeProof<NUM_RANGE_CLAIMS, RANGE_CLAIM_LIMBS, L>,
>;
