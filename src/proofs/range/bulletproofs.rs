...
pub enum Error {
    #[error("the aggregated commitments of the bulletproofs range proof did not match the concatenation of players individual commitments")]
...
/// commitments.
///
/// This allows `RangeProof::verify()` to get the actual aggregated commitments as the parameter
...
/// commitments of each of the players in order to verify the proof.
///
/// For non-aggregated commitments, the commitments generated by bulletproofs are valid and
...
impl PartialEq for RangeProof {
    fn eq(&self, other: &Self) -> bool {
        (self.proof.to_bytes() == other.proof.to_bytes())
            && (self.aggregation_commitments == other.aggregation_commitments)
    }
}
