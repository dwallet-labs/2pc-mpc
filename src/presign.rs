...
pub(crate) mod tests {
    ...
    pub fn generates_presignatures_internal(
        ...
        let centralized_party_nonce_shares_commitments = commitments_and_proof_to_centralized_party_nonce_shares
            .commitments
            .into_iter().map(|value| secp256k1::GroupElement::new(value, &secp256k1_group_public_parameters).unwrap());
