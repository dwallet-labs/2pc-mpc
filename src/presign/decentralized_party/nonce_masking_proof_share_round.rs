...
use crate::{
    ...
    presign::decentralized_party::{
        nonce_masking_proof_aggregation_round, nonce_masking_proof_share_round,
    ...
    >: From<enhanced::ConstrainedWitnessValue<RANGE_CLAIMS_PER_SCALAR, WITNESS_MASK_LIMBS>>,
{
    ...
    pub(super) nonce_sharing_proof: encryption_of_discrete_log::EnhancedProof<
        SCALAR_LIMBS,
        COMMITMENT_SCHEME_MESSAGE_SPACE_SCALAR_LIMBS,
        RANGE_CLAIMS_PER_SCALAR,
    ...
    pub(super) key_share_masking_proof: encryption_of_tuple::Proof<
        ...
        ProtocolContext,
    >,
    pub(super) nonce_masking_proof_share_round_party:
    ...
    >: From<enhanced::ConstrainedWitnessValue<RANGE_CLAIMS_PER_SCALAR, WITNESS_MASK_LIMBS>>,
{
    pub fn decommit_nonce_masking(
        ...
        encryption_of_tuple::ProofShare<
            ...
            RangeProof,
        >,
        nonce_masking_proof_aggregation_round::Party<
            SCALAR_LIMBS,
            COMMITMENT_SCHEME_MESSAGE_SPACE_SCALAR_LIMBS,
            RANGE_CLAIMS_PER_SCALAR,
            PLAINTEXT_SPACE_SCALAR_LIMBS,
        ...
        let (nonce_masking_proof_share, nonce_masking_proof_aggregation_round_party) = self
            .nonce_masking_proof_share_round_party
            .generate_proof_share(decommitments)?;

        let party = nonce_masking_proof_aggregation_round::Party::<
            SCALAR_LIMBS,
            COMMITMENT_SCHEME_MESSAGE_SPACE_SCALAR_LIMBS,
            RANGE_CLAIMS_PER_SCALAR,
            PLAINTEXT_SPACE_SCALAR_LIMBS,
        ...
        Ok((nonce_masking_proof_share, party))
    }
}
