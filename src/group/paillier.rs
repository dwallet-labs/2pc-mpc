...
pub type PlaintextPublicParameters =
    odd_moduli::PublicParameters<{ LargeBiPrimeSizedNumber::LIMBS }>;
...
pub type CiphertextPublicParameters = multiplicative_group_of_integers_modulu_n::PublicParameters<
