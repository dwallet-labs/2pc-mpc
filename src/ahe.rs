...
mod tests {
    ...
    fn bla() {
        let key =
            paillier::EncryptionKey::<{ U384::LIMBS }, { U256::LIMBS }, secp256k1::Scalar>::new(
                &paillier::PublicParameters::<
                    { U384::LIMBS }, { U256::LIMBS }, secp256k1::Scalar>::new(
                    N,
    ...
    #[rstest]
    #[case(paillier::EncryptionKey::< { U384::LIMBS }, { U256::LIMBS }, secp256k1::Scalar >::new(
    & paillier::PublicParameters::<
    { U384::LIMBS }, { U256::LIMBS }, secp256k1::Scalar >::new(
    N,
    ), & secp256k1::scalar::PublicParameters::default(),
